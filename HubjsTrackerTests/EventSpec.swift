...
//  Copyright © 2019 Hubjs. All rights reserved.
//
...
class EventSpec: QuickSpec {
    override func spec() {
        var tracker: HubjsTracker!

        beforeEach {
            tracker = HubjsTracker(siteId: "5", baseURL: URL(string: "https://analytics.hub-js.com/tracking.php")!)
        }
