...
class HubjsUserDefaultsSpec: QuickSpec {
    override func spec() {
        describe("suiteMigration") {
            it("should migrate data for the default suite") {
                ...
                var userDefaults = HubjsUserDefaults(suiteName: "_specSuite")
    ...
    private func setMigrateableData(totalNumberOfVisists: Int, firstVisit: Date?, previousVisit: Date?, currentVisit: Date?, optOut: Bool, clientId: String?) {
        UserDefaults.standard.set(totalNumberOfVisists, forKey: HubjsUserDefaults.Key.totalNumberOfVisits)
        UserDefaults.standard.set(firstVisit, forKey: HubjsUserDefaults.Key.firstVistsTimestamp)
        UserDefaults.standard.set(previousVisit, forKey: HubjsUserDefaults.Key.previousVistsTimestamp)
        UserDefaults.standard.set(currentVisit, forKey: HubjsUserDefaults.Key.currentVisitTimestamp)
        UserDefaults.standard.set(optOut, forKey: HubjsUserDefaults.Key.optOut)
        UserDefaults.standard.set(clientId, forKey: HubjsUserDefaults.Key.clientID)
    }
}
